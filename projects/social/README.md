...
_all_possible_friendships = [(1,2), (1,3), (1,4), (2,3), (2,4), ]
...
_ANSWER: To get an average of 10 friends per 100 user, we will need 500, as there need to be 500 pairs/friendships total._

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?
_ANSWER: The average percentage of users will be in a particular user's extended network is around 90%. It looks like the average degree of separation is around 5_
...
_ANSWER: Some people are more connected than others. Some people are staunchly not more connected. Probability of being more connected goes up with the number of friendships. If a person has gotten 10 friendships, they're increasingly likely to have 11 friendships._
...
_ANSWER: Suggestion: just keep getting "random" friendships and if they've already been added, just find another pair? no need to make full set of all possible friends and just run til we hit required # of friendships; SEE CODE; with a dense graph, it does not appear as efficient; if people have a higher average number of friendships_
